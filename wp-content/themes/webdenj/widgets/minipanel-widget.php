<div class="minipanel">
    <div class="minipanel__top">
        <?php
        global $user;
        $display_name = $user->display_name;
        ?>
        <span class="user_display_name">سلام <?php echo $display_name; ?></span>
        <a href="<?php echo wp_logout_url( home_url() ); ?>" class="user_logout">
    ...
    <div class="minipanel__bottom">
        <ul class="minipanel__bottom__menu">
            <li class="minipanel__bottom__menu--item">
            ...
            <li class="minipanel__bottom__menu--item">
                <a href="<?php echo home_url('/my-account/my-courses');?>">
